...
export function Playing({ room, playerId, send, error, onLeave }: PlayingProps) {
  ...
  const submitAnswer = () => {
    ...
    send({ type: "SUBMIT_ANSWER", cardId: selectedCardId });
  };
    ...
    <div className="min-h-screen flex flex-col"
            ...
            <div className="flex items-center gap-1 mt-0.5 flex-wrap">
              {room.players.map(p => (
                <div key={p.id} className="flex items-center gap-1 bg-white/10 rounded-full px-2 py-0.5">
                  ...
                  <span className="text-xs font-bold text-white">{p.name.slice(0, 6)}</span>
      ...
      <div className="px-4 pt-4">
        ...
        <div className="max-w-lg mx-auto">
          <div className="bg-black/80 border-2 border-gray-600 rounded-2xl p-5 mb-4 shadow-2xl"
          ...
          <div className="max-w-lg mx-auto w-full flex-1 flex flex-col">
            {isQM ? (
              ...
              <>
                ...
                <div className="flex-1 overflow-y-auto overflow-x-hidden space-y-2 mb-4 pr-1" style={{ maxHeight: "40vh" }}>
                  {myHand.map(card => (
                    <button
                      key={card.id}
                      ...
                      className={`w-full text-left p-4 rounded-xl border-2 transition-all font-semibold text-sm ${
                        selectedCardId === card.id
                          ? "bg-white border-rose-400 text-gray-900 shadow-lg scale-[1.02]"
                ...
                <button
                  ...
                  disabled={selectedCardId === null || submitted}
                  ...
                  style={{ background: selectedCardId !== null ? "linear-gradient(135deg, #e91e63, #c2185b)" : "#4a5568" }}
                >
      ...
      {room.phase === "playing-judge" && (
        <div className="flex-1 flex flex-col px-4 pb-4">
          <div className="max-w-lg mx-auto w-full flex-1 flex flex-col">
            {isQM ? (
              <>
                <h3 className="text-white font-black text-lg text-center mb-4">
                ...
                <div className="flex-1 overflow-y-auto space-y-3 pr-1" style={{ maxHeight: "55vh" }}>
