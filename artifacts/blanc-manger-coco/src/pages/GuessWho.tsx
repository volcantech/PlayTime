      ...
      <div className="min-h-screen flex flex-col items-center justify-start px-4 py-8"
        ...
        <div className="bg-white rounded-2xl shadow-lg p-5 w-full max-w-sm mb-4">
          ...
          <p className="text-xs text-gray-400 text-center mt-2">
            {room.isPrivate ? "Seuls les joueurs avec ce code ou ce lien peuvent rejoindre" : "Partage ce lien pour inviter un adversaire"}
          </p>
        </div>
        ...
        {isHost && room.players.length === 2 && (
          <button
            ...
            className="w-full max-w-sm py-3 bg-rose-600 text-white font-black rounded-xl text-lg hover:bg-rose-700 transition-colors mb-3"
          >
        ...
        {!isHost && room.players.length === 2 && (
          <p className="text-gray-500 text-sm mb-3">En attente de l'hôte pour démarrer…</p>
        )}
