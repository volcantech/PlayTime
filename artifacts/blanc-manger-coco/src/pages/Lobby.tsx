      ...
      <div className="w-full max-w-sm relative z-10">
        ...
        <div className="text-center mb-7">
          ...
          <h1
            ...
            style={{ background: "linear-gradient(135deg, #fff 30%, #e91e63)", WebkitBackgroundClip: "text", WebkitTextFillColor: "transparent" }}
          >
            Salle d'attente
          </h1>
        ...
        >
          ...
          <button
            ...
            style={copied ? {
              ...
              background: "rgba(233,30,99,0.15)", color: "#f06292", border: "1px solid rgba(233,30,99,0.3)",
            }}
          >
        ...
        {isHost && (
          ...
          >
                ...
                {[5, 10, 15].map(score => (
                  <button
                    ...
                    style={room.targetScore === score ? {
                      background: "#e91e63", color: "#fff", boxShadow: "0 4px 15px rgba(233,30,99,0.4)",
                    } : {
            ...
            {/* Vote mode */}
            <div>
              <h2 className="font-black text-white/50 mb-1 text-xs uppercase tracking-widest">Mode de vote</h2>
              <p className="text-xs text-white/25 mb-3">Qui choisit la meilleure réponse ?</p>
              <div className="space-y-2">
                {([
                  {
                    id: "classic" as const,
                    icon: "👑",
                    label: "Classique",
                    desc: "Le Question Master choisit seul la meilleure carte",
                    accent: "#fbbf24",
                  },
                  {
                    ...
                    icon: "🗳️",
                    label: "Démocratique",
                    desc: "Tout le monde vote — anonyme, le QM aussi",
                    accent: "#c084fc",
                  },
                  ...
                  >
                    ...
                    {voteMode === id && <span className="font-black text-sm">✓</span>}
                  </button>
                ))}
              </div>
            </div>
        ...
        {!isHost && (
          ...
          >
            ...
            {voteMode === "democratic" && <p className="text-xs font-bold mt-1" style={{ color: "#c084fc" }}>🗳️ Vote démocratique activé</p>}
          </div>
        )}
