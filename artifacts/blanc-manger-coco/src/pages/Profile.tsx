...
export function ProfilePage({ onBack }: ProfilePageProps) {
  ...
  const totalLosses = stats ? Object.values(stats).reduce((a, b) => a + (b.losses ?? 0), 0) : 0;
      ...
      <div className="w-full max-w-sm">
        ...
        <div className="bg-white/90 backdrop-blur rounded-2xl shadow-xl p-6 mb-4 text-center">
          ...
          <div className="mt-3 flex items-center justify-center gap-2 flex-wrap">
            ...
            <span className="bg-gray-50 text-gray-600 text-sm font-bold px-3 py-1 rounded-full">💀 {totalLosses} défaite{totalLosses !== 1 ? "s" : ""}</span>
