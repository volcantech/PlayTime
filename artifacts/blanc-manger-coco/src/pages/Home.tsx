          ...
          <div className="p-5 space-y-4">
            ...
            {spectateHint && tab === "join" && spectateHint.gameType === "connect4" && (
              <div className="rounded-2xl overflow-hidden" style={{ border: "1px solid rgba(99,102,241,0.3)" }}>
                <div className="px-4 py-3" style={{ background: "rgba(99,102,241,0.1)" }}>
                  <p className="text-sm font-bold text-white/80 mb-0.5">La partie a déjà commencé</p>
                  <p className="text-xs text-white/40">Tu peux regarder la partie en spectateur.</p>
                </div>
                <div className="px-4 py-3 flex flex-col gap-2" style={{ background: "rgba(99,102,241,0.07)" }}>
                  <button
                    onClick={() => {
            ...
            {/* CTA Button — hide when spectateHint is showing */}
